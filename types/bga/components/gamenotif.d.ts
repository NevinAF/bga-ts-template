...
interface GameNotif {
	...
	playerBufferQueue: Record<string, { notifs: Notifs, counter: number }>;
	 ...
	 */
	setIgnoreNotificationCheck: <T extends keyof NotifTypes>(notif_type: T, predicate: ((notif: NotifFrom<NotifTypes[T]>) => boolean)) => void;
	...
	onNotification: (notifs_or_json: Notifs | string) => void;
