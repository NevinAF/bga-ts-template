...
Gamegui.prototype.cloneHTMLWithoutIds = function(this: Gamegui, element: Element, ...maintainEvents: (keyof HTMLElementEventMap)[]): HTMLElement
{
...
Gamegui.prototype.isTitleLocked = function(this: Gamegui): boolean
{
	return (this.titlelock_element != undefined) && this.titlelock_element.childElementCount > 0;
}

Gamegui.prototype.createTitleLock = function(this: Gamegui): HTMLElement
{
...
Gamegui.prototype.lockTitleWithStatus = function(this: Gamegui, status: string): void
{
...
Gamegui.prototype.lockTitleWithHTML = function(this: Gamegui, html: string | HTMLElement): void
{
	this.titlelock_element ??= this.createTitleLock();
...
Gamegui.prototype.lockTitle = function(this: Gamegui, target?: 'pagemaintitle_wrap' | 'gameaction_status_wrap'): void
{
...
Gamegui.prototype.pushTitleLockFromStatus = function(this: Gamegui, status: string): void
{
	this.titlelock_element ??= this.createTitleLock();
...
Gamegui.prototype.pushTitleLockFromHTML = function(this: Gamegui, html: string | HTMLElement): void
{
	this.titlelock_element ??= this.createTitleLock();
...
Gamegui.prototype.pushTitleLock = function(this: Gamegui, target?: 'pagemaintitle_wrap' | 'gameaction_status_wrap'): void
{
	this.titlelock_element ??= this.createTitleLock();
...
Gamegui.prototype.popTitleLockWithoutUpdate = function(this: Gamegui): boolean
{
...
Gamegui.prototype.popTitleLock = function(this: Gamegui): boolean
{
	if (!this.titlelock_element) return false;
...
Gamegui.prototype.removeTitleLocks = function(this: Gamegui): void
{
