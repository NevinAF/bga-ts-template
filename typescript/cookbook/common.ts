...
declare global {
	...
	interface Gamegui
	{
		 ...
		 * @param ajax_method The method to use for the ajax call. See {@link BGACore.ajaxcall} for more information.
...
Gamegui.prototype.attachToNewParentNoDestroy = function(this: Gamegui, mobile_in: string | HTMLElement, new_parent_in: string | HTMLElement, relation?: dojo.PosString | number, place_position?: string): dojo.DomGeometryBox
{
...
Gamegui.prototype.ajaxAction = function<T extends keyof PlayerActions>(this: Gamegui, action: T, args: PlayerActions[T] & { lock?: true | 'table' | 'player', action?: undefined, module?: undefined, class?: undefined }, callback?: (error: boolean, errorMessage?: string, errorCode?: number) => any, ajax_method?: 'post' | 'get'): boolean
{
...
Gamegui.prototype.subscribeNotif = function<T extends keyof NotifTypes>(event: T, callback: (notif: NotifAs<T>) => any): dojo.Handle
{
	return dojo.subscribe(event, this, callback);
}

Gamegui.prototype.addImageActionButton = function(this: Gamegui, id: string, label: string, method: string | Function, destination?: string, blinking?: boolean, color?: 'blue' | 'red' | 'gray' | 'none', tooltip?: string): Element
{
	if (!color) color = "gray";
...
Gamegui.prototype.isReadOnly = function(this: Gamegui): boolean
{
	return this.isSpectator || typeof g_replayFrom !== 'undefined' || g_archive_mode;
}

Gamegui.prototype.scrollIntoViewAfter = function(this: Gamegui, target: string | HTMLElement, delay?: number): void
{
...
Gamegui.prototype.divYou = function(this: Gamegui): string
{
	return this.divColoredPlayer(this.player_id, __("lang_mainsite", "You"));
}

Gamegui.prototype.divColoredPlayer = function(this: Gamegui, player_id: number, text?: string): string
{
...
Gamegui.prototype.setMainTitle = function(this: Gamegui, html: string): void
{
	$('pagemaintitletext').innerHTML = html;
}

Gamegui.prototype.setDescriptionOnMyTurn = function(this: Gamegui, description: string): void
{
